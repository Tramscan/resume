...
\newcommand{\MissionStatement}{
  ...
  \begin{center}
    \begin{minipage}{0.9\textwidth}
      ...
      Experienced robotics engineer with expertise in robotics controls and software development, seeking to apply advanced skills in nonlinear dynamics, control theory, and mechanism design to create innovative solutions in robotics control and intelligent systems.
    \end{minipage}
  \end{center}
...
\newcommand{\WorkExperienceResearch}{
  ...
  \begin{itemize}
  \item Developed innovative design features for a sensor assembly, playing a key role in a cross-functional team by exploring trade spaces and implementing new solutions.
...
\newcommand{\ProjectExperienceResearch}{
  ...
  \entry{\href{https://nickcline.com/portfolio/furuta-simulation}{Robotic Simulation}}
  \begin{itemize}
  ...
  \entry{\href{https://nickcline.com/portfolio/gearbox-design}{Robotic System Design}}
  \begin{itemize}
