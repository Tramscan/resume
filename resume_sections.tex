...
\newcommand{\WorkExperienceResearch}{
  ...
  \textit{Mechanical Instrumentation Engineer II, Software Developer}
  \begin{itemize}
  ...
  \item Programmed modular data visualization tools for detailed analysis of data, implemented tools for improving program automation.
