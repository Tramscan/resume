...
\newcommand{\SkillsInterests}{
  ...
  \noindent\begin{tabular}{@{}m{4em}@{\hspace{0.5em}}m{\dimexpr\textwidth-4.5em}@{}}
    \centering\textbf{Skills:} & 
    \centering\begin{minipage}[c]{\linewidth}
      Atlassian Suite, C, C++, Python, Rust, Julia, MATLAB, Solidworks, ROS 2, Gazebo, Drake, MPC, Nonlinear Dynamics, OpenCV.
    \end{minipage} \\[0.5em]
