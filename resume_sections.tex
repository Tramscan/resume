...
\newcommand{\MissionStatement}{
  ...
  \begin{center}
    \begin{minipage}{0.9\textwidth}
      ...
      Experienced mechanical engineer with expertise in robotics control systems and software development, seeking to apply advanced skills in AI, machine learning, and mechanism design to create innovative solutions in robotics control and intelligent systems.
    \end{minipage}
  \end{center}
...
\newcommand{\SkillsInterests}{
  ...
  \noindent\begin{tabular}{@{}p{5.5em}@{\hspace{0.5em}}p{\dimexpr\textwidth-6em-2\tabcolsep\relax}@{}}
    ...
    \end{minipage} & 
    Atlassian Suite, C, C++, Python, Rust, Julia, MATLAB, Solidworks, ROS 2, Gazebo, Drake, MPC, Nonlinear Dynamics, OpenCV. \\[-0.25em]
    \begin{minipage}[c][1.25\baselineskip][c]{5.5em}
...
\newcommand{\ProjectExperienceResearch}{
  ...
  \entry{\href{https://nickcline.com/portfolio/furuta-simulation}{Robotic Simulation}}{October 2023 -- Present}
  \begin{itemize}
  ...
  \entry{\href{https://nickcline.com/portfolio/gearbox-design}{Robotic System Design}}{January 2023 -- Present}
  \begin{itemize}
  ...
  \entry{\href{https://nickcline.com/interactive-robotics}{Personal Website Tools}}{June 2024 -- Present}
  \begin{itemize}
