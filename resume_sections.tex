...
\newcommand{\WorkExperienceResearch}{
  ...
  \textit{Mechanical Instrumentation Engineer II, Sofware Developer}
  \begin{itemize}
  ...
  \item Programmed modular data visualization tools for detailed analysis of data, implemented tools for improving and automating processes.
